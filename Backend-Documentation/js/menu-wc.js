...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Procurement App Backend Documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/ProductRoutes.html" data-type="entity-link" >ProductRoutes</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="classes/UserRoutes.html" data-type="entity-link" >UserRoutes</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/IModelUser.html" data-type="entity-link" >IModelUser</a>
                            </li>
                            <li class="link">
